...
export default function Footer() {
    return (
                        ...
                        <div className="col-lg-6">
                            <div className="social-part ps-lg-5">
                                ...
                                <ul className="social-list d-flex flex-wrap align-items-center mb-0">
                                     <li className="social-link"><Link to="#" data-blast="bgColor"><i
                                                className="icofont-telegram"></i></Link></li>
                                    <li className="social-link"><Link to="#" data-blast="bgColor"><i
                                                className="icofont-twitter"></i></Link></li>
                                    <li className="social-link"><Link to="#" data-blast="bgColor"><i
                                                className="icofont-facebook"></i></Link></li>
                                    
                                    <li className="social-link"><Link to="#" data-blast="bgColor"><i
                                                className="icofont-instagram"></i></Link></li>
                    ...
                    <div className="row ">
                        ...
                        <div className="col-md-2 col-sm-6">
                            <div className="footer-link-item">
                                ...
                                <ul className="footer-link-list">
                                    ...
                                    <li><Link to="#" className="footer-link">How to connect wallet</Link></li>
                        ...
                        <div className="col-md-2 col-sm-6">
                            <div className="footer-link-item">
                                ...
                                <ul className="footer-link-list">
                                    <li><Link to="#" className="footer-link">All NFTs</Link></li>
                                    <li><Link to="#" className="footer-link">New</Link></li>
                                    <li><Link to="#" className="footer-link">Art</Link></li>
                                    <li><Link to="#" className="footer-link">Collectibles</Link></li>
                                    <li><Link to="#" className="footer-link">More</Link></li>
                                </ul>
                            </div>
                        </div>
                        <div className="col-md-2 col-sm-6">
                            <div className="footer-link-item">
                                <h5>My Account</h5>
                                <ul className="footer-link-list">
                                    <li><Link to="#" className="footer-link">Create</Link></li>
                                    <li><Link to="#" className="footer-link">Profile</Link></li>
                                    <li><Link to="#" className="footer-link">Favorites</Link></li>
                                    <li><Link to="#" className="footer-link">My Collections</Link></li>
                                    <li><Link to="#" className="footer-link">Settings</Link></li>
                                </ul>
                            </div>
                        </div>
                        <div className="col-md-2 col-sm-6">
                            <div className="footer-link-item">
                                ...
                                <ul className="footer-link-list">
                                    ...
                                    <li><Link to="#" className="footer-link">RegoNFT Contract</Link></li>
                                </ul>
                            </div>
                        </div>
                    </div>
        ...
        <div className="footer-bottom">
            <div className="container">
                <p className="text-center py-4 mb-0 black-color">All rights reserved &copy;RegoNFT || Design By: <Link
                        className="theme-color" to="https://questglt.com">Questglt</Link>
                </p>
            </div>
        </div>
    </footer>
