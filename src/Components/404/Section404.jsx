                  ...
                  <div className="section-wrapper">
                      <div className="error-item">
                          <div className="error-thumb">
                              <svg className="svg404" viewBox="0 0 1000 480">
                                  {/* <!-- cloud icon --> */}
                                  <path id="cloud" className="st0"
                        	...
                        	c-11.4,0-20.6-9.2-20.6-20.6c0-11.4,9.2-20.6,20.6-20.6h21.2c11.4,0,20.6,9.2,20.6,20.6C353.3,177.9,344.1,187.1,332.8,187.1z" />
                                  {/* <!-- monkey-icon --> */}
                                  <g id="monkey">
                                      <path id="foot_back" className="st4"
                                      ...
                                      <path id="foot_front" className="st5"
                                      ...
                                      <path id="nose_hole" className="st10" d="M213.2,266.3c0.6,0,1,0.5,0.9,1.1c0,0.6-0.5,1-1.1,0.9c-0.6,0-1-0.5-0.9-1.1
                        		C212.1,266.6,212.6,266.2,213.2,266.3z" />
                                      <path id="nose_hole_1_" className="st10" d="M208.1,266.9c0.6,0,1,0.5,0.9,1.1c0,0.6-0.5,1-1.1,0.9c-0.6,0-1-0.5-0.9-1.1
                        		C207.1,267.3,207.6,266.9,208.1,266.9z" />
                                      <path id="monkey-eye-r" className="st10"
                                          d="M205,253.5c1.1,0.1,1.9,1,1.9,2.1c-0.1,1.1-1,1.9-2.1,1.9c-1.1-0.1-1.9-1-1.9-2.1 C203,254.3,203.9,253.4,205,253.5z" />
                                      <path id="monkey-eye-l" className="st10"
                        		...
                        		c7.2,4.8,16.6,5.3,20.8,2.8C199.5,302.9,199,301.2,198.4,300z" />
                                      <path id="belly" className="st11" d="M189.1,304c6.2,3,8.1,11.5,5.9,19c-2.3,7.4-9.8,10-16,7c-6.2-3-7.6-10.4-5.3-17.8
                        		S182.9,301.1,189.1,304z" />
                                      <path id="belly_button" className="st9" d="M191.2,322.3c0-0.1-0.1-0.2-0.2-0.2l-1.9-1.4l1-1.9c0.1-0.1,0.1-0.2,0-0.3
                        		...
                        		c0.1,0.1,0.3,0.1,0.5,0.1C191.1,322.8,191.3,322.5,191.2,322.3z" />
                                      <g id="monkey_arm">
                                          <path id="monkey-arm" className="st5" d="M164.3,344.1c-0.9-0.3-1.8-0.2-2.5,0.2c-0.3-0.2-0.6-0.3-0.9-0.4c-0.8-0.3-1.5-0.5-2.3-0.5
                        			...
                        			c0-0.1,0-0.2,0.1-0.2c0.5-0.7,0.9-1.6,0.5-2.9C166.2,345.5,165.4,344.4,164.3,344.1z" />
                                          <g id="armpit">
                                              <path className="st12" d="M165,296c0-4.3-1.8-10.8-6-12c-12.5-3.5-12.4,11.1-12.4,11.1s10.8-1.4,16.7,9.6
                                  ...
                                  {/* <!-- white moon --> */}
                                  <g id="moon">
                                      <path id="moon_body" className="st5"
                                          d="M641,34c26,0,47,21,47,47s-21,47-47,47s-47-21-47-47S615,34,641,34z" />
                                      <path id="moon_shades" className="st0" d="M622.5,55.9c1.3,2.3,0,5.8-3.1,7.7c-3,2-6.6,1.7-7.9-0.6c-1.3-2.3,0-5.8,3.1-7.7
                        		...
                        		C681.9,103.6,686.5,92.8,686.5,81z" />
                                  ...
                                  {/* <!-- 4 --> */}
                                  <g id="number_4">
                                      <path id="number_4_outline" className="st1"
                        		...
                        		c6,0,10.5-4.5,10.5-10.1v-24.3h11.4C375.6,244.3,379.5,240.4,379.5,235.5z M339,226.4h-45.5l45.5-67.8V226.4z" />
                                      <path id="number_4_inner_lines" className="st14"
                        		...
                        		c-1.2,1.9-3.3,4.3-3.6,5.8c-0.8,4.6,2.3,5.5,7.3,5.5H340 M359.5,235H379 M342,232l-4,7 M345,232l-4,7 M358,232l-4,7 M361,232l-4,7" />
                                      <path id="number_4_dots" className="st10"
                        		...
                        		z M344.4,144.6c1.6,0,2.9,1.3,2.9,2.9c0,1.6-1.3,2.9-2.9,2.9c-1.6,0-2.9-1.3-2.9-2.9C341.4,145.9,342.7,144.6,344.4,144.6z" />
                                  ...
                                  {/* <!-- 4 last --> */}
                                  <g id="number_4_2">
                                      <path id="number_4_outline_2" className="st1"
                        		...
                        		c6,0,10.5-4.5,10.5-10.1v-24.3h11.4C623.1,244.3,627,240.4,627,235.5z M586.5,226.4H541l45.5-67.8V226.4z" />
                                      <path id="number_4_inner_lines_2" className="st14" d="M596.5,158v109.2 M593.3,147c-5.6,0-10.9,2.8-14,7.2l-47.1,69.5
                        		c-1.2,1.9-3.3,4.3-3.6,5.8c-0.8,4.6,2.3,5.5,7.3,5.5h51.5 M607,235h19.5 M589.5,232l-4,7 M592.5,232l-4,7 M605.5,232l-4,7
                        		 M608.5,232l-4,7" />
                                      <path id="number_4_dots_2" className="st10" d="M596.5,266c1.6,0,2.9,1.3,2.9,2.9c0,1.6-1.3,2.9-2.9,2.9c-1.6,0-2.9-1.3-2.9-2.9
                        		...
                        		C588.9,145.9,590.2,144.6,591.8,144.6z" />
                                  ...
                                  {/* <!-- 0 --> */}
                                  <g id="number_0">
                                      <path id="number_0_outline" className="st1" d="M502,208.9c0-34-15.9-70.9-54-70.9c-38.3,0-54,36.9-54,70.9s15.7,71.1,54,71.1
                        		...
                        		C472.4,156.1,481.1,182.1,481.1,208.9z" />
                                      <path id="number_0_inner_lines" className="st15" d="M487.2,175.7c-6.7-16.8-19.3-29.4-39.2-29.4c-32,0-45.1,32.5-45.1,62.4
                        		...
                        		C487,204.5,489.5,202,492.5,202z" />
                                      <path id="number_0_dots" className="st10" d="M492.5,205c1.4,0,2.5,1.1,2.5,2.5c0,1.4-1.1,2.5-2.5,2.5c-1.4,0-2.5-1.1-2.5-2.5
                        		...
                        		C445.1,269.6,446.4,268.3,448.1,268.3z" />
                                  ...
                                  <g id="sword-path">
                                      <g id="sword">
                                          <path id="sword_handle" className="st5"
                                          ...
                                          <path id="sword_handle_line" className="st14"
                                              d="M453.9,197c2,1.5,2.4,4.3,0.9,6.3l-0.6,0.8c-1.5,2-4.3,2.4-6.3,0.9" />
                                          <path id="sword_hilt" className="st5"
                                          ...
                                          <polygon id="sword_blade" className="st1"
                                              points="437,199 446,187.3 387.3,138.9 366.3,136.7 372.2,154 	" />
                                          <polygon id="sword_blade_shadow" className="st0"
