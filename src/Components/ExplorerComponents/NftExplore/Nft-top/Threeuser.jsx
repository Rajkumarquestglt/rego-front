...
export default function Threeuser(props) {
  return (
          ...
          <div className="author-part">
              <ul className="author-list d-flex">
                  <li className="single-author">
                      <Link to="author.html">
                          <img loading="lazy" src={require("../../../../assets/images/seller/01.png")} alt="author-img" />
                      </Link>
                  </li>
                  <li className="single-author">
                      <Link to="author.html">
                          <img loading="lazy" src={require("../../../../assets/images/seller/01.gif")} alt="author-img" />
                      </Link>
                  </li>
                  <li className="single-author d-flex align-items-center">
                      <Link to="author.html" className="veryfied">
                          <img loading="lazy" src={require("../../../../assets/images/seller/02.png")} alt="author-img" />
                      </Link>
                      <h6>
