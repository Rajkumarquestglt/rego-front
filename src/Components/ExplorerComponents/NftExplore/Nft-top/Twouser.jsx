...
export default function Twouser(props) {
  return (
          ...
          <div className="author-part">
              <ul className="author-list d-flex">
                  <li className="single-author">
                      <Link to="author.html">
                          <img loading="lazy" src={require("../../../../assets/images/seller/06.png")} alt="author-img" />
                      </Link>
                  </li>
                  <li className="single-author d-flex align-items-center">
                      <Link to="author.html" className="veryfied">
                          <img loading="lazy" src={require("../../../../assets/images/seller/05.gif")} alt="author-img" />
                      </Link>
                      <h6>
