                ...
                <div className="item-desc-part">
                  <div className="item-desc-inner">
                    <div className="item-desc-thumb">
                      <img
                        src={require('../assets/images/nft-item/item-details-light.gif')}
                        alt="item-img"
                      />
                    </div>
                    <div className="item-desc-content">
                      ...
                      <div className="tab-content" id="nav-tabContent">
                        ...
                        >
                          <p>
                            This is the second batch of Cybertino Genesis NFTs for early adopters
                            and is 1 of 5. This Genesis NFT will be interactive: hold and wait for
                            future exclusive benefits and early access to new drops!
                          </p>
