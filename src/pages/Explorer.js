                    ...
                    <div className="nft-inner">
                      ...
                      <div className="nft-item-bottom">
                        <div className="nft-thumb">
                          <img
                            loading="lazy"
                            src={require('../assets/images/nft-item/02.gif')}
                            alt="nft-img"
                          />
                    ...
                    <div className="nft-inner">
                        ...
                        <div className="author-part">
                          <ul className="author-list d-flex">
                            ...
                            <li className="single-author d-flex align-items-center">
                              ...
                              <h6>
                                <Link to="author.html">Ecalo jers</Link>
                              </h6>
                            </li>
                          </ul>
                        </div>
                      ...
                      <div className="nft-item-bottom">
                        <div className="nft-thumb">
                          <img
                            loading="lazy"
                            src={require('../assets/images/nft-item/01.jpg')}
                            alt="nft-img"
                          />
                    ...
                    <div className="nft-inner">
                        ...
                        <div className="author-part">
                          <ul className="author-list d-flex">
                            ...
                            <li className="single-author d-flex align-items-center">
                              ...
                              <h6>
                                <Link to="author.html">Hola moc</Link>
                              </h6>
                            </li>
                          </ul>
                        </div>
                      ...
                      <div className="nft-item-bottom">
                        <div className="nft-thumb">
                          <img
                            loading="lazy"
                            src={require('../assets/images/nft-item/06.gif')}
                            alt="nft-img"
                          />
                        ...
                        <div className="nft-content">
                          <h4>
                            <Link to="item-details.html">pet mice rio</Link>{' '}
                          </h4>
                          <div className="price-like d-flex justify-content-between align-items-center">
                            <p className="nft-price">
                              Price: <span className="yellow-color">0.34 ETH</span>
                  ...
                  <div className="nft-item light-version">
                    <div className="nft-inner">
                          ...
                          <ul className="author-list d-flex">
                            <li className="single-author">
                              <Link to="author.html">
                                <img
                                  loading="lazy"
                                  src={require('../assets/images/seller/06.png')}
                                  alt="author-img"
                                />
                              </Link>
                            </li>
                            <li className="single-author d-flex align-items-center">
                              ...
                              <h6>
                                <Link to="author.html">Logicto pen</Link>
                              </h6>
                            </li>
                          </ul>
                        </div>
                      ...
                      <div className="nft-item-bottom">
                        ...
                        <div className="nft-content">
                          <h4>
                            <Link to="item-details.html">Logical Impact </Link>{' '}
                          </h4>
                          <div className="price-like d-flex justify-content-between align-items-center">
                            <p className="nft-price">
                              Price: <span className="yellow-color">0.34 ETH</span>
                    ...
                    <div className="nft-inner">
                          ...
                          <ul className="author-list d-flex">
                            ...
                            <li className="single-author d-flex align-items-center">
                              <Link to="author.html" className="veryfied">
                                <img
                                  loading="lazy"
                                  src={require('../assets/images/seller/09.png')}
                                  alt="author-img"
                                />
                              </Link>
                              <h6>
                                <Link to="author.html">unique lo</Link>
                              </h6>
                            </li>
                          </ul>
                        </div>
                      ...
                      <div className="nft-item-bottom">
                        <div className="nft-thumb">
                          <img
                            loading="lazy"
                            src={require('../assets/images/nft-item/03.jpg')}
                            alt="nft-img"
                          />
                        ...
                        <div className="nft-content">
                          <h4>
                            <Link to="item-details.html">Fly on high</Link>{' '}
                          </h4>
                          <div className="price-like d-flex justify-content-between align-items-center">
                            <p className="nft-price">
                              Price: <span className="yellow-color">0.34 ETH</span>
                  ...
                  <div className="nft-item light-version">
                    <div className="nft-inner">
                        ...
                        <div className="author-part">
                          <ul className="author-list d-flex">
                            <li className="single-author d-flex align-items-center">
                              ...
                              <h6>
                                <Link to="author.html">Monica bel</Link>
                              </h6>
                            </li>
                          </ul>
                        </div>
                      ...
                      <div className="nft-item-bottom">
                        ...
                        <div className="nft-content">
                          <h4>
                            <Link to="item-details.html">kiara rodri de</Link>{' '}
                          </h4>
                          <div className="price-like d-flex justify-content-between align-items-center">
                            <p className="nft-price">
                              Price: <span className="yellow-color">0.34 ETH</span>
                    ...
                    <div className="nft-inner">
                          ...
                          <ul className="author-list d-flex">
                            <li className="single-author">
                              <Link to="author.html">
                                <img
                                  loading="lazy"
                                  src={require('../assets/images/seller/08.gif')}
                                  alt="author-img"
                                />
                              </Link>
                            </li>
                            ...
                            <li className="single-author d-flex align-items-center">
                              <Link to="author.html" className="veryfied">
                                <img
                                  loading="lazy"
                                  src={require('../assets/images/seller/11.png')}
                                  alt="author-img"
                                />
                              </Link>
                              <h6>
                      ...
                      <div className="nft-item-bottom">
                        <div className="nft-thumb">
                          <img
                            loading="lazy"
                            src={require('../assets/images/nft-item/05.jpg')}
                            alt="nft-img"
                          />
                  ...
                  <div className="nft-item light-version">
                    <div className="nft-inner">
                          ...
                          <ul className="author-list d-flex">
                            ...
                            <li className="single-author">
                              <Link to="author.html">
                                <img
                                  loading="lazy"
                                  src={require('../assets/images/seller/07.png')}
                                  alt="author-img"
                                />
                              </Link>
                            </li>
                            <li className="single-author d-flex align-items-center">
                              ...
                              <h6>
                                <Link to="author.html">ptrax elm.</Link>
                              </h6>
                            </li>
                          </ul>
                        </div>
                      ...
                      <div className="nft-item-bottom">
                        ...
                        <div className="nft-content">
                          <h4>
                            <Link to="item-details.html">Homies wall</Link>{' '}
                          </h4>
                          <div className="price-like d-flex justify-content-between align-items-center">
                            <p className="nft-price">
                              Price: <span className="yellow-color">0.34 ETH</span>
                    ...
                    <div className="nft-inner">
                      ...
                      <div className="nft-item-bottom">
                        <div className="nft-thumb">
                          <img
                            loading="lazy"
                            src={require('../assets/images/nft-item/01.gif')}
                            alt="nft-img"
                          />
                    ...
                    <div className="nft-inner">
                      ...
                      <div className="nft-item-bottom">
                        <div className="nft-thumb">
                          <img
                            loading="lazy"
                            src={require('../assets/images/nft-item/06.jpg')}
                            alt="nft-img"
                          />
                    ...
                    <div className="nft-inner">
                      ...
                      <div className="nft-item-bottom">
                        <div className="nft-thumb">
                          <img
                            loading="lazy"
                            src={require('../assets/images/nft-item/03.gif')}
                            alt="nft-img"
                          />
                    ...
                    <div className="nft-inner">
                      ...
                      <div className="nft-item-bottom">
                        <div className="nft-thumb">
                          <img
                            loading="lazy"
                            src={require('../assets/images/nft-item/08.jpg')}
                            alt="nft-img"
                          />
